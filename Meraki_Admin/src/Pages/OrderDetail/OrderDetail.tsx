                ...
                <div className="flex flex-row justify-between items-center w-full">
                    <div className=" flex flex-row justify-start items-start gap-7">
                        ...
                        <div className="flex flex-col justify-start items-start  text-start">
                            ...
                            <h1 className="text-slate-600">{data?.order.user.role === 'ADMIN' ? data?.order?.customer_name : data?.order.user.name}</h1>
                            <h1 className="text-slate-600">{data?.order?.customer_email}</h1>
                    ...
                    <div className=" flex flex-row justify-start items-start gap-7">
                        ...
                        <div className="flex flex-col justify-start items-start  text-start">
                            ...
                            <h1 className="text-slate-600">{data?.order.createdByAdmin === true ? 'Order Created By Admin' : 'order created by' + data?.order.user.name}</h1>
                    ...
                    <div className=" flex flex-row justify-start items-start gap-7">
                        ...
                        <div className="flex flex-col justify-start items-start  text-start">
                            ...
                            <h1 className="text-slate-600">{data?.order?.customer_address}</h1>
                            <h1 className="text-slate-600">{data?.order?.customer_address_landmark}</h1>
                        </div>
                    </div>
                </div>
